...
export function JsonDiffViewInner({
  ...
  return (
    <div className="flex size-full flex-col bg-background">
      <div className="flex h-10 shrink-0 items-center justify-between gap-2 border-b border-border bg-muted/40 px-4 text-xs">
        <div className="flex items-center gap-4 text-muted-foreground">
          <span className="font-medium">Left:</span>
          <span>Current editor</span>
          <span className="text-border">·</span>
          <span className="font-medium">Right:</span>
          <span>Comparison ({modified.length.toLocaleString()} chars)</span>
        </div>
